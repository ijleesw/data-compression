...
class HuffmanCoding:
    def __init__(self, path, com, decom):
        self.path = path
        self.com_path = com
        self.decom_path = decom
        self.heap = []
        self.codes = {}
    ...
    def compress(self):
        ...
        output_path = self.com_path

        with codecs.open(self.path, 'r+', encoding='latin-1') as file, open(output_path, 'wb') as output:
            text = file.read()
            text = text.rstrip()
