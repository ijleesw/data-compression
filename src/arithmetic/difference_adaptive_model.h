...
#define USE_VARIABLES_FROM_PARENT() \
    using adaptive_model<symbolT>::m_cum_count; \
    using adaptive_model<symbolT>::m_encoder; \
    using adaptive_model<symbolT>::m_decoder; \
    using adaptive_model<symbolT>::update; \
    using adaptive_model<symbolT>::cum_count; \
    using adaptive_model<symbolT>::total_count; \
    using adaptive_model<symbolT>::search_index;

template <typename symbolT>
class difference_adaptive_model : public adaptive_model<symbolT>
{
  USE_VARIABLES_FROM_PARENT();
private:
